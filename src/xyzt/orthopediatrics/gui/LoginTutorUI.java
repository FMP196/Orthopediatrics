...
public class LoginTutorUI extends JFrame
{
	/**
	 ...
	 * Autenticazione del tutore nel caso di utenti minorenni
	 * @param database - Database 
	 * @param paziente - Paziente minorenne
	 */
	public LoginTutorUI(final Paziente paziente, final Database database)
	{		
		setResizable(false);
		...
		lblLogin = new JLabel("Login Tutor");
		...
		btnLogin.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (tutore == null)
					new UISupport().notifyDialogTutorNotValid(username);
				else {
					if (paziente.getTutore().equals(tutore.getNomeutente())) {
